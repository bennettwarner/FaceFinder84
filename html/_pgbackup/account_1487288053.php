    ...
    <body>
        ...
        <div id="top-nav" class="navbar navbar-inverse navbar-static-top">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Broadcast Dashboard</a>
                </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <!-- column 2 -->
                    <a href="#"><strong><i class="glyphicon glyphicon-cog"></i> Account Settings</strong></a>
                    <hr>
                    <div class="row">
                        <div class="col-md-2">
</div>
                            ...
                            <div class="panel">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane well" id="settings">
                                        ...
                                        <p>If you have any questions about billing, please feel free&nbsp;to email <a href="mailto:support@streamforcemedia.com">support@streamforcemedia.com</a></p>
                                    </div>
                                </div>
                            </div>
                            <!--/tabs-->
