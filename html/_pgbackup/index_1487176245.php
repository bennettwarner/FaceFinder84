    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="login/signup.php"><i class="glyphicon glyphicon-flash"></i> Register</a></li>
                <li><a href="login/main_login.php"><i class="glyphicon glyphicon-lock"></i> Login</a></li>
            </ul>
        </div>
    </div>
    <!-- /container -->
...
<footer class="text-center">This service is provided by <a href="http://streamforcemedia.com/"><strong>StreamForce Media</strong></a></footer>
